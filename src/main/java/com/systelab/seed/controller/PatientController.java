...
public class PatientController {
    ...
    @ApiOperation(value = "Get allergies of a Patient", authorizations = {@Authorization(value = "Bearer")})
    @GetMapping("patients/{uid}/allergies")
    public ResponseEntity<Collection<PatientAllergy>> getPatientsByAllergy(@PathVariable("uid") UUID id) {
        Patient thePatient = this.patientService.getPatient(id);
        
        return ResponseEntity.ok(thePatient.getAllergies());
    }
